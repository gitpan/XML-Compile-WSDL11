...
more readible or solve naming conflicts.  See XML::Compile::WSDL11 subroutine compileCall option prefixed
...
=item $obj-E<gt>B<addWSDL>($xmldata, %options)
...
This module is part of XML-Compile-WSDL11 distribution version 3.03,
